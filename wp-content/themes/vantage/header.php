...
<div class="container">
	<div class="row">
		<div style="    text-align: right;" class="co-md-12 ">
...
<div id="main-navigation" style="padding-top: 15px;" class="container">
	<div class="row">
		<div id="rounded-nav-box" class="rounded">
			<div id="rounded-nav-box-overlay">
				<?php va_display_navigation_menu(); ?>
				<form method="get" action="<?php echo trailingslashit( home_url() ); ?>" class="header-search">
					<div id="main-search">
						<div class="search-for">
							<div>
								<?php /*<label for="search-text" class="search-title"><?php _e( 'Search For ', APP_TD ); ?></label>*/?>
				...
				<div class="area-header-ads"><?php dynamic_sidebar('Second Header Area') ?></div>
			</div>
		</div>
	</div>
</div>

<?php/* <div id="breadcrumbs" class="container">
	<div class="row">
