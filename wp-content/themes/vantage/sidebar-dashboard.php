<div id="sidebar">
	...
	<aside id="dashboard-side-nav">
		...
		<ul class="links">
			<?php if ( $is_own_dashboard ) {
				echo html( 'li', array( 'class' => 'faves' ), html_link( va_dashboard_url( 'favorites', $dashboard_user->ID, $is_own_dashboard ), __( 'Favorite Network', APP_TD ) ) );
			} ?>
			...
			<?php echo html( 'li', array( 'class' => 'view-listings' ), html_link( va_dashboard_url( 'listings', $dashboard_user->ID, $is_own_dashboard ), __( 'View Network', APP_TD ) ) ); ?>
			...
			<li class="add-listings"><?php echo html_link( va_get_listing_create_url(), __( 'Add Network / Program', APP_TD ) ); ?></li>
