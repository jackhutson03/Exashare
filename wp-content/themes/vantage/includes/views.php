...
class VA_Listing_Archive extends APP_View {
	...
	function parse_query( $wp_query ) {
		...
		switch ( $orderby ) {
			case 'ten':
					$result_id12s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayment' AND exashare_postmeta.meta_value LIKE '10' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id12s );
				break;
				
				case 'tw':
					$result_id12s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayment' AND exashare_postmeta.meta_value LIKE '20' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id12s );
				break;
				case 'th':
					$result_id12s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayment' AND exashare_postmeta.meta_value LIKE '30' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id12s );
				break;
				case 'fr':
					$result_id12s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayment' AND exashare_postmeta.meta_value LIKE '40' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id12s );
				break;
				case 'fi':
					$result_id12s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayment' AND exashare_postmeta.meta_value LIKE '50' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id12s );
				break;
			case 'highest_rating':
			...
			case 'recently_reviewed':
				...
				case 'net_30':
					$result_id12s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'net-30' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id12s );
				break;
				case 'net_15':
					$result_id13s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'net-15' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id13s );
				break;
				case 'net_60':
					$result_id13s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'net-60' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id13s );
				break;
				case 'daily':
					$result_id13s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'daily' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id13s );
				break;
				case 'weekly':
					$result_id13s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'weekly' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id13s );
				break;
			case 'rand':
	...
	function parse_query( $wp_query ) {
		...
		switch ( $orderby ) {
			case 'net_30':
				...
				break;
				case 'net_60':
					$result_id11s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'net-60' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id11s );
				break;
				case 'daily':
					$result_id14s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'daily' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id14s );
				break;
				case 'weekly':
					$result_id15s = $wpdb->get_col( $wpdb->prepare( "SELECT exashare_posts.* FROM exashare_posts, exashare_postmeta WHERE exashare_posts.ID = exashare_postmeta.post_id  AND exashare_postmeta.meta_key = 'networkpayfrequency' AND exashare_postmeta.meta_value RLIKE 'weekly' AND exashare_posts.post_status = 'publish' AND exashare_posts.post_type = 'listing' AND exashare_posts.post_date < NOW() ORDER BY exashare_posts.post_date DESC",VA_LISTING_PTYPE) );
					$wp_query->set( 'orderby', 'post__in' );
					$wp_query->set( 'post__in', $result_id15s );
				break;
			case 'highest_rating':
				$wp_query->set( 'meta_key', 'rating_avg' );
				$wp_query->set( 'orderby', 'meta_value, comment_count' );
