...
class VA_Listing_Contact_Metabox extends APP_Meta_Box {
	...
	public function __construct() {
		parent::__construct( 'listing-contact', __( 'Network Information', APP_TD ), VA_LISTING_PTYPE, 'normal' );
	}

	public function form_fields() {
       $fields = array(
		array(
				'title' => __( 'Network Type CPA (For show CPA listing please put 1)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networktypecheck',
				'extra' => array(
					'class' => 'net-tpye-cpa'
				),
			),
			 array(
			'title' => __( 'video,Image hosting (For show video & Image listing please put 2)', APP_TD ),
				'type'  => 'text',
				'name'  => 'hosttypecheck',
				'extra' => array(
					'class' => 'hostonig-type'
		    ...
		    array(
				'title' => __( 'Affiliate Network URL', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkurl',
			),
			...
			array(
				'title' => __( 'AIM Screen Name', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkaimname',
			),
			 ...
			 array(
				'title' => __( 'How many offers in your network? (50+, 100+, etc)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkmanyoffers',
			),
			 /* array(
				'title' => __( 'Featured offers in your network (Aliexpress, Whatsapp, Netflix ...)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkoffers',
			), */
			 array(
				'title' => __( 'Commission Type (CPA, CPL, CPI, CPS ...)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkcommission',
			),
			 array(
				'title' => __( 'Minimum Payment ($50, $100, etc)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkpayment',
			),
			 array(
				'title' => __( 'Payment Frequency (net-30, net-15, weekly, etc)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkpayfrequency',
			),
			 array(
				'title' => __( 'Payment Method (check, paypal, wire, etc)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkpaymethod',
			),
			 array(
				'title' => __( 'Referral Commission (2%, 5%, etc)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networkrefcommission',
			),
			 array(
				'title' => __( 'Affiliate Tracking Software (HasOffers, CAKE, In-house ...)', APP_TD ),
				'type'  => 'text',
				'name'  => 'networktracking',
			),
			 array(
				'title' => __( 'Tracking Link', APP_TD ),
				'type'  => 'text',
				'name'  => 'networktrackinglink',
			),
			
			 
			 array(
				'title' => __( 'Maximum File size', APP_TD ),
				'type'  => 'text',
				'name'  => 'maxsizefile',
			),
			 ...
			 array(
				'title' => __( 'Storage Size', APP_TD ),
				'type'  => 'text',
				'name'  => 'storagesizes',
			),
			
			 array(
				'title' => __( 'Uploading speed', APP_TD ),
				'type'  => 'text',
				'name'  => 'uploadspeed',
			),
			 array(
				'title' => __( 'Downloading speed', APP_TD ),
				'type'  => 'text',
				'name'  => 'downloadspeed',
			),
			 array(
				'title' => __( 'File Types Supported', APP_TD ),
				'type'  => 'text',
				'name'  => 'filesupport',
			),
			 array(
				'title' => __( 'Reward Program', APP_TD ),
				'type'  => 'text',
				'name'  => 'reward',
			),
			 array(
				'title' => __( 'Uploading Methods' ,APP_TD ),
				'type'  => 'text',
				'name'  => 'uploadingmethods',
			),
			 array(
				'title' => __( 'Payment for 10000 views/downloads' ,APP_TD ),
				'type'  => 'text',
				'name'  => 'perdownload',
			),
		);
