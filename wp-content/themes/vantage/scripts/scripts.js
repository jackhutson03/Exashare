jQuery(function() {
	...
	function switch_to_tab(tab_id) {
		if ( tab_id == '#overview' ) {
			...
			jQuery('#paymentproof-tab').removeClass('active-tab');
			jQuery('#paymentproof').hide();
			jQuery('#questions-tab').removeClass('active-tab');
			...
			jQuery('#overview-tab').removeClass('active-tab');
			jQuery('#overview').hide();
		} else if ( tab_id == '#paymentproof' ) {
			jQuery('#paymentproof-tab').addClass('active-tab');
			jQuery('#paymentproof').show();
			jQuery('#reviews-tab').removeClass('active-tab');
			jQuery('#reviews').hide();
			jQuery('#questions-tab').removeClass('active-tab');
			jQuery('#questions').hide();
			jQuery('#overview-tab').removeClass('active-tab');
			jQuery('#overview').hide();
		}else if ( tab_id == '#questions' ) {
			jQuery('#questions-tab').addClass('active-tab');
	...
	if ( 0 === window.location.hash.indexOf('#paymentproof') ) {
		switch_to_tab('#paymentproof');
	...
	if ( 0 === window.location.hash.indexOf('#questions') ) {
		switch_to_tab('#questions');
...
jQuery(function($){
	...
	var url1 = "http://webappsample.com/demo/exashare/listings/?orderby=top_reviewed";
	var url2 = "http://webappsample.com/demo/exashare/listings/?orderby=highest_rating";
	var url3 = "http://webappsample.com/demo/exashare/listings/?orderby=newest";
	
	var url4 = "http://webappsample.com/demo/exashare/listings/?orderby=all_frequencies";
	var url5 = "http://webappsample.com/demo/exashare/listings/?orderby=weekly";
	var url6 = "http://webappsample.com/demo/exashare/listings/?orderby=daily";
	var url7 = "http://webappsample.com/demo/exashare/listings/?orderby=net_60";
	var url8 = "http://webappsample.com/demo/exashare/listings/?orderby=net_30";
	var url9 = "http://webappsample.com/demo/exashare/listings/?orderby=net_15";
	
	var url10 ="http://webappsample.com/demo/exashare/listings/?orderby=all_minimum_payout";
	var url11 ="http://webappsample.com/demo/exashare/listings/?orderby=ten";
	var url12 ="http://webappsample.com/demo/exashare/listings/?orderby=tw";
    var url13 ="http://webappsample.com/demo/exashare/listings/?orderby=th";
    var url14 ="http://webappsample.com/demo/exashare/listings/?orderby=fr";
	var url15 ="http://webappsample.com/demo/exashare/listings/?orderby=fi";
	
	if(url1 == pathname){
		$('.selected1 > p').text("All Frequencies");
		$('.selected2 > p').text("Minimum Payout");
	}
	if(url2 == pathname){
		$('.selected1 > p').text("All Frequencies");
		$('.selected2 > p').text("Minimum Payout");
