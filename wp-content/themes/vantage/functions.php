...
function header_second_area_widgets_init() {
register_sidebar( array(
    'name' => __( 'Second Header Area', 'vantage-theme' ),
    'id' => 'sidebar-2',
    'description' => __( 'Second header widget area for ads', 'vantage-theme' ),
...
add_action( 'widgets_init', 'header_second_area_widgets_init' );
add_image_size( 'listp-thumb', 75, 75, true ); 

add_image_size( 'archive-thumbnail', 220, 150, true );   
set_post_thumbnail_size( 220, 150 );

add_filter( 'excerpt_length', 'td_excerptLength' );
function td_excerptLength( $length ) { return 25; }

function add_comment_author_to_reply_link($link, $reviews, $review){
    ...
    $reply_link_text = $reviews['reply_text'];
